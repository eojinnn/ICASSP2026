...
from utility.seldloss_adpit import SELDLoss_ADPIT
...
def main(argv):
    ...
    for split_cnt, split in enumerate(test_splits):
        ...
        # loss preparation
        if params['multi_accdoa'] is True and params['multi_task_loss'] is False: # multi_task_loss only for task 33
            criterion = MSELoss_ADPIT()
        elif params['multi_accdoa'] is True and params['multi_task_loss'] is True:
            criterion = SELDLoss_ADPIT()
        else:
